	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'mom':
				...
				case 'tabatha':
				tex = Paths.getSparrowAtlas('tabatha_assets');
				frames = tex;

				animation.addByPrefix('idle', "TABBY IDLE", 24, false);
				animation.addByPrefix('singUP', "TABBY UP", 24, false);
				animation.addByPrefix('singDOWN', "TABBY DOWN", 24, false);
				animation.addByPrefix('singLEFT', 'TABBY LEFT', 24, false);
				// ANIMATION IS CALLED MOM LEFT POSE BUT ITS FOR THE RIGHT
				// CUZ DAVE IS DUMB!
				animation.addByPrefix('singRIGHT', 'TABBY RIGHT', 24, false);
